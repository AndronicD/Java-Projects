// Generated from C:/Users/andro/Desktop/Tema1/Tema1/src/cool/parser/CoolParser.g4 by ANTLR 4.13.1
...
public class CoolParser extends Parser {
	...
	public static final int
		ERROR=1, WS=2, STRING=3, IF=4, THEN=5, ELSE=6, FI=7, CLASS=8, FALSE=9, 
		TRUE=10, IN=11, INHERITS=12, ISVOID=13, LET=14, LOOP=15, POOL=16, WHILE=17, 
		CASE=18, ESAC=19, NEW=20, OF=21, NOT=22, AT=23, DOT=24, COLON=25, TILDE=26, 
		SELF=27, TYPE=28, SEMI=29, COMMA=30, LPAREN=31, RPAREN=32, LBRACE=33, 
		RBRACE=34, PLUS=35, MINUS=36, MULT=37, DIV=38, EQUAL=39, LT=40, LE=41, 
		RE=42, DARROW=43, ID=44, INT=45, FLOAT=46, LINE_COMMENT=47, BLOCK_COMMENT=48, 
		INVALID_CHAR=49;
	public static final int
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "class", "feature", "formal", "local", "expr"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, null, null, null, "'if'", "'then'", "'else'", "'fi'", "'class'", 
			"'false'", "'true'", "'in'", "'inherits'", "'isvoid'", "'let'", "'loop'", 
			"'pool'", "'while'", "'case'", "'esac'", "'new'", "'of'", "'not'", "'@'", 
			"'.'", "':'", "'~'", "'self'", null, "';'", "','", "'('", "')'", "'{'", 
			"'}'", "'+'", "'-'", "'*'", "'/'", "'='", "'<'", "'<='", "'=>'", "'<-'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "ERROR", "WS", "STRING", "IF", "THEN", "ELSE", "FI", "CLASS", "FALSE", 
			"TRUE", "IN", "INHERITS", "ISVOID", "LET", "LOOP", "POOL", "WHILE", "CASE", 
			"ESAC", "NEW", "OF", "NOT", "AT", "DOT", "COLON", "TILDE", "SELF", "TYPE", 
			"SEMI", "COMMA", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "PLUS", "MINUS", 
			"MULT", "DIV", "EQUAL", "LT", "LE", "RE", "DARROW", "ID", "INT", "FLOAT", 
			"LINE_COMMENT", "BLOCK_COMMENT", "INVALID_CHAR"
		};
	}
	...
	public final ClassContext class_() throws RecognitionException {
		...
		try {
			...
			if (_la==INHERITS) {
				...
				match(INHERITS);
				setState(24);
				((ClassContext)_localctx).type = _input.LT(1);
				_la = _input.LA(1);
				if ( !(_la==TYPE || _la==ID) ) {
					((ClassContext)_localctx).type = (Token)_errHandler.recoverInline(this);
				}
				else {
	...
	public static class Case_exprContext extends ExprContext {
		...
		public TerminalNode COLON() { return getToken(CoolParser.COLON, 0); }
		public TerminalNode RE() { return getToken(CoolParser.RE, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode TYPE() { return getToken(CoolParser.TYPE, 0); }
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 52787502540312L) != 0)) {
					{
					setState(80);
					expr(0);
					setState(85);
			...
			case 4:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 52787502540312L) != 0) );
				setState(113);
				match(RBRACE);
				}
				break;
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(169);
						((MultdivContext)_localctx).rightExp = expr(16);
						}
						break;
					case 2:
						{
						...
						setState(172);
						((PlusminusContext)_localctx).rightExp = expr(15);
						}
						break;
					case 3:
						{
						...
						match(LT);
						setState(175);
						((Less_thanContext)_localctx).rightExp = expr(13);
						}
						break;
					case 4:
						{
						...
						match(LE);
						setState(178);
						((Less_than_or_equalContext)_localctx).rightExp = expr(12);
						}
						break;
					case 5:
						{
						...
						match(EQUAL);
						setState(181);
						((EqualContext)_localctx).rightExp = expr(11);
						}
						break;
					case 6:
						{
